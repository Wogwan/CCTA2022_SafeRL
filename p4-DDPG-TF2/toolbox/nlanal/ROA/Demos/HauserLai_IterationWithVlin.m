%------------------------------------------------------------------
% Hauser & Lai Example with VS Iteration Initialized with Vlin
%   Compute an estimate of the region of attraction for Hauser and
%   Lai example using the V-S iteration.  The iteration is 
