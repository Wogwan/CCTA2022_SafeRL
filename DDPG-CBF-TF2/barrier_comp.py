...
class BARRIER():
    ...
    def create_mlp_model(self):
        ...
        out = tf.keras.layers.Dense(units=30, use_bias=True, name='h1', activation='relu', kernel_initializer=tf.keras.initializers.TruncatedNormal(stddev=0.01))(inputs)
        out = tf.keras.layers.Dense(units=20, use_bias=True, name='h2', activation='relu', kernel_initializer=tf.keras.initializers.TruncatedNormal(stddev=0.01))(out)
        out = tf.keras.layers.Dense(units=self.action_size, use_bias=True, name='h3', kernel_initializer=tf.keras.initializers.TruncatedNormal(stddev=0.01))(out)
