function [mean1,hyp1,rmse_poly] = gpr_xdot2(x,y,xtest,ytest,it,noise,poly_deg)
%%
tic
format long
syms x1 x2;
...
syms x1 x2
dXtr_3 = reshape(double(subs(dxdt2,{x1},{xtest(:,1)})),1,[])';
error_2 = abs(ytest-dXtr_3);
rmse_poly = sqrt(sum(error_2.^2)/n)
% fprintf('RMSE-Poly is \n%f',rmse_poly,'/n');
