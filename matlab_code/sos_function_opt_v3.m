function [cc,kk,solu1,solu2]=sos_function_opt_v3(f,gg,k,k_l,V,C,dom,solL,ccc,figure_id)
%%
kk = 1;
...
pconstr_u = [];
for i = 1:length(uc2)
    pconstr_u = [pconstr_u; uc2(1)<=input_bundary; uc2(i)>=-input_bundary];
end
%%
% pconstr_4 = cc >= ccc;
pconstr_4 = cc >= 0;
...
%     pconstr = [pconstr_21;pconstr_22;pconstr_1;pconstr_31;pconstr_32;pconstr_4];
    pconstr = [pconstr_21;pconstr_22;pconstr_1;pconstr_31;pconstr_32;pconstr_4;pconstr_u];
elseif length(C) == 3
    pconstr_23 = L3 >= 0;
    pconstr_33 = -(cc-V)+C(3)*L3 >= 0;
%     pconstr = [pconstr_21;pconstr_22;pconstr_23;pconstr_1;pconstr_31;pconstr_32;pconstr_33;pconstr_4];
    pconstr = [pconstr_21;pconstr_22;pconstr_23;pconstr_1;pconstr_31;pconstr_32;pconstr_33;pconstr_4;pconstr_u];
elseif length(C) == 4
    pconstr_23 = L3 >= 0;
    pconstr_33 = -(cc-V)+C(3)*L3 >= 0;
    pconstr_24 = L4 >= 0;
