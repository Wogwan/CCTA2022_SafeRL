...
def parse_args():
    ...
    parser.add_argument('--max-episodes', help='max number of episodes for training', default=750) # 150*5
    ...
    for i in range(int(args['max_episodes'])):
        ...
        for j in range(int(args['max_episode_len'])):
            ...
            if terminal:
                ...
                print('-'*20)
                path = {"Observation": np.concatenate(obs).reshape((int(args['max_episode_len']), env.observation_space.shape[0])), # (200, 3)
