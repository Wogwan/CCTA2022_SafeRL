function yd = f18fullUnc(t,x,u,opts)
%
...
% % -------------------------------------------------
% Rolling Moment   
Clb     =  F18Aero.Clb_0 + (F18Aero.Clb_1 + opts.d2)*alpha + F18Aero.Clb_2*alpha^2 ...
...
Clp     =  F18Aero.Clp_0 + (F18Aero.Clp_1+ opts.d5)*alpha; 
...
% -------------------------------------------------
%  Yawing Moment
Cnb     = F18Aero.Cnb_0 + (F18Aero.Cnb_1 + opts.d3)*alpha + F18Aero.Cnb_2*alpha^2 ; 
...
Cnr     = F18Aero.Cnr_0 + (F18Aero.Cnr_1+ opts.d4)*alpha; 
...
Cyb     = F18Aero.Cyb_0 + (F18Aero.Cyb_1 + opts.d1)*alpha + F18Aero.Cyb_2*alpha^2 ; 
...
% -------------------------------------------------
% Pitching Moment           
Cma     =  F18Aero.Cma_0 + (F18Aero.Cma_1 + opts.d7)*alpha + F18Aero.Cma_2*alpha^2; 
Cmds    =  F18Aero.Cmds_0 + F18Aero.Cmds_1*alpha + F18Aero.Cmds_2*alpha^2; 
Cmq     =  F18Aero.Cmq_0 + (F18Aero.Cmq_1 + opts.d8)*alpha + F18Aero.Cmq_2*alpha^2 ...
...
alphad = -Lift*secbeta/m/V + q + opts.d6 - tanbeta*(p*cosalpha + r*sinalpha)...
